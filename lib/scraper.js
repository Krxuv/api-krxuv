...
//Fixed by: Kimimaru | kimimaru.site
// Module
	...
	return new Promise((resolve, rejecet) => {
        ...
        axios.request({
            ...
            const result = {
                ...
                video: ch('body > div.welcome.section > div.container > div:nth-child(2) > div.col.s12.l8 > a').attr('href'),
                video2: hc('body > div.welcome.section > div.container > div:nth-child(2) > div.col.s12.l8 > a + br + a').attr('href'),
                videohd: ch('body > div.welcome.section > div.container > div:nth-child(2) > div.col.s12.l8 > a + br + a + br + a').attr('href'),
                videowm: ch('body > div.welcome.section > div.container > div:nth-child(2) > div.col.s12.l8 > a + br + a + br + a + br + a').attr('href')
            }
        resolve(result)
        })
    })
